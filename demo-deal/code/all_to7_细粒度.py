...
def online_submit():
    ...
    sub_data.to_csv('../data/lgb_all_to7.txt',index=False,sep=' ')
    ...
    sub_data.rename(columns={0:'predicted_score'},inplace=True)
    sub_data.to_csv('../data/sub_lr_5_1.txt',index=False,sep=' ')
    ########################################################################################
    train_index=train_x.axes[1]
    X = train_x[train_index]
    y = train_y.values
    ...
    sub_data.rename(columns={0:'predicted_score'},inplace=True)
    print(sub_data['predicted_score'].mean())
    sub_data.to_csv('../data/xgb_all.txt',index=False,sep=' ')
