...
class DeepFM(torch.nn.Module):
    ...
    """
    def __init__(self,field_size, feature_sizes, embedding_size = 8, is_shallow_dropout = True, dropout_shallow = [0.5,0.5],
                 ...
                 optimizer_type = 'adam', is_batch_norm = False, verbose = False, random_seed = 981015, weight_decay = 0.0,
    ...
    def evaluate(self, Xi, Xv, y):
        ...
        #return logloss(y.cpu().data.numpy(), y_pred)
