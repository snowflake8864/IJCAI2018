...
class FNN(torch.nn.Module):
    ...
    def __init__(self, field_size, feature_sizes, embedding_size=4,
                 ...
                 deep_layers_activation='tanh', n_epochs=64, batch_size=256, learning_rate=0.001,
                 optimizer_type='adam', is_batch_norm=False, verbose=False, random_seed=981015, pre_weight_decay= 0.0,weight_decay=0.0001,
