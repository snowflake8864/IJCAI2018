...
def feat_before_1day():
    ...
    data.to_csv('../data/only7_2.txt',index=False)
    ...
    #data=pd.merge(data,std_feat,'left',on=['item_city_id'])
        ...
        print(p2)
        #data.to_csv('../data/only7_3.txt',index=False)'''
    ...
    data.to_csv('../data/only7_1.txt',index=False)
...
feat.to_csv('../data/before_1day_all.txt',index=False)
#################################################
print('load_data_ori...')
data_train=pd.read_csv('../data/data_train_ori_b.csv')
print(len(data_train))
...
def feat_before_1day():
    data=all_data[(all_data['times']>='2018-09-07 00:00:00') & (all_data['times']<='2018-09-07 23:59:59')]
...
feat.to_csv('../data/only7_all.txt',index=False)
...
feat.to_csv('../data/all.txt',index=False)
####################################################################
print('load_data_ori...')
data_train=pd.read_csv('../data/data_train_ori_b.csv')
print(len(data_train))
...
#data_train_PH=pd.read_csv('../data/data_train_PH_7_b.csv')
#data_test_PH=pd.read_csv('../data/data_test_PH_7_b.csv')
count_prep_tianyin=pd.read_csv('../data/other_feat/count_prep_tianyin.csv')
#print('count_prep_tianyin:%d'%(len(count_prep_tianyin)))
#print(count_prep_tianyin.index)
category_count_after=pd.read_csv('../data/other_feat/category_count_after.csv')
#print('category_count_after:%d'%(len(category_count_after)))
#print(category_count_after.index)
...
'user_shop_id_nexttime_delta','user_brand_id_nexttime_delta','user_category_id_nexttime_delta',]]
    ...
    train_before_1=pd.read_csv('../data/before_1day_all.txt')
    ...
    train_only_feat=pd.read_csv('../data/only7_all.txt')
    train_only_feat=pd.merge(train_only_feat,a_time,'left',on='instance_id')
    train_only_feat_train=train_only_feat[(train_only_feat['times']>='2018-09-07 00:00:00') & (train_only_feat['times']<='2018-09-07 11:59:59')]
    del train_only_feat_train['times']
    train_x=pd.merge(train_x,train_only_feat_train,'left',on='instance_id')
    
    
    train_all_1=pd.read_csv('../data/all.txt')
    train_all_1_train=train_all_1[(train_all_1['times']>='2018-09-07 00:00:00') & (train_all_1['times']<='2018-09-07 11:59:59')]
    del train_all_1_train['times']
    train_x=pd.merge(train_x,train_all_1_train,'left',on='instance_id')
...
'user_shop_id_nexttime_delta','user_brand_id_nexttime_delta','user_category_id_nexttime_delta',]]
    ...
    train_only_feat_test=train_only_feat[(train_only_feat['times']>='2018-09-07 12:00:00') & (train_only_feat['times']<='2018-09-07 23:59:59')]
    del train_only_feat_test['times']
    test_x=pd.merge(test_x,train_only_feat_test,'left',on='instance_id')
    
    train_all_1_test=train_all_1[(train_all_1['times']>='2018-09-07 12:00:00') & (train_all_1['times']<='2018-09-07 23:59:59')]
    del train_all_1_test['times']
    test_x=pd.merge(test_x,train_all_1_test,'left',on='instance_id')
    ...
    lgb_train = lgb.LGBMClassifier(num_leaves=128, learning_rate=0.01,n_estimators=1830,colsample_bytree = 0.8,
    ...
    sub_data.to_csv('../submit/lgb_all_to7_add_ty_addonly7_addbefore1.txt',index=False,sep=' ')
